...
public class Subcatageoriesfunctionality  extends Basetest {
	...
	public void Sub_Catageories_Add() throws Throwable {
		...
		Thread.sleep(2000);
		editlength.click();
		ArgUtils.Dropdown(editlength, "100");
		Thread.sleep(2000);
	...
	public void Delete_SubCategoryAssertMessage() {
		...
		if (AssertJUnit2.isDisplayed()) {
			...
			dev.failsafe.internal.util.Assert.assertTrue("Add Element is displayed.", true);
		} else {
			System.out.println("Delete Element is not displayed.");
			dev.failsafe.internal.util.Assert.fail("Delete Element is not displayed.");
